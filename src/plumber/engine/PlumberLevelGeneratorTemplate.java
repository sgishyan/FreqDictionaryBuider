 ...
 */
public class  PlumberLevelGeneratorTemplate {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    int [][] template;
    public PlumberLevelGeneratorTemplate(int count, int minComplexity, int maxComplexity) throws IOException {
        ...
        while(levelsGenerated < count) {
           ...
           //TOTAL_ANGLES = 10 + rand.nextInt(4);
            ...
            PlumberModelOld model = generateLevelWithTemplate(template);
...
//                }
    ...
    private PlumberModelOld generateLevelWithTemplate(int [][] template) {
...
//        }
        ...
        int doubleTubes = TOTAL_TUBES - tubes;
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberLevelGeneratorTemplate generator = new PlumberLevelGeneratorTemplate(365, 0, 100);
