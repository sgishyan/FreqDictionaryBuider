 ...
 */
public class PlumberLevelGeneratorNewMOdes {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    public PlumberLevelGeneratorNewMOdes(int count, int minComplexity, int maxComplexity) {
        ...
        int[] difficulties =    {
                ...
                29, 29, 29, 34, 29, 29, 29, 29,
                34, 29, 29, 29, 29, 29, 39, 29,   //4/2-th pack

                35, 30, 30, 30, 30, 35, 30, 30,
                30, 30, 30, 40, 30, 30, 30, 30,   //5-th pack

                31, 31, 31, 31, 31, 31, 31, 31,
                30, 30, 30, 40, 30, 30, 30, 30,   //5/2-th pack
        ...
        while(levelsGenerated < count) {
           ...
           //TOTAL_ANGLES = 10 + rand.nextInt(4);
            ...
            PlumberModelOld model = generateLevel();
...
//                }
    ...
    private PlumberModelOld generateLevel() {
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberLevelGeneratorNewMOdes generator = new PlumberLevelGeneratorNewMOdes(365, 0, 100);
