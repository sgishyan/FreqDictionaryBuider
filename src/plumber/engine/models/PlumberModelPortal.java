...
public class PlumberModelPortal extends Model {
    ...
    public PlumberModelPortal(int[][] array, ArrayList<SolutionSegment> solution, int h, int w, ArrayList<Point> arrayOfCoords) {
    ...
    public PlumberModelPortal(int[][] board, int heigth, int width) {
