 ...
 */
public class PlumberFireFighterLevelDailyGenerator {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    public PlumberFireFighterLevelDailyGenerator(int count, int minComplexity, int maxComplexity) {
...
//            }
            ...
            ArrayList<ArrayList<WaterPath>> solution = model.findAllShortestPaths(6);
            ...
            if (solution != null) {
               ...
               // System.out.println("Difficulty " +difficulty);
                //   //Todo open after 1 levels
                   if (Math.abs(difficulty - dif) > eps ) {
                       System.out.println("Desired " + dif +  "     Actual "  + difficulty);
                      continue;
                   }
//                for(int i = 0; i < count; i++) {
...
//                }
                ...
                writeToFile("/home/suren/Documents/temp/plumber/for_sale/extreme_fire/" + (levelNumber + levelsGenerated) + ".txt", solution);
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberFireFighterLevelDailyGenerator generator = new PlumberFireFighterLevelDailyGenerator(365, 0, 100);
