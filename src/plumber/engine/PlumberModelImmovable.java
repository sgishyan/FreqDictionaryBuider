...
public class PlumberModelImmovable {
    ...
    private boolean[][] immovableArray;



	public PlumberModelImmovable(int[][] array, boolean[][] imArray,int h, int w)
	{		
		height=h;
		width=w;
        immovableArray = imArray;
