 ...
 */
public class WordsFormWord5_ENG {
    public static final String DICTIONARY_FILENAME_ENG_ELEMENTARY = "/home/suren/Documents/languages/English/english1.txt";
    public static final String DICTIONARY_FILENAME_ENG_EASY = "/home/suren/Documents/languages/English/english2.txt";
    public static final String DICTIONARY_FILENAME_ENG_NORMAL = "/home/suren/Documents/languages/English/english3.txt";
    public static final String DICTIONARY_FILENAME_ENG_HARD = "/home/suren/Documents/languages/English/english4.txt";
    private static final int SHUFFLE_ITERATIONS = 10;
    ...
    public static void main(String[] args) throws IOException {
        WordsFormWord5_ENG w = new WordsFormWord5_ENG();

    }

    public WordsFormWord5_ENG() throws IOException {

        dictionary = readFile(DICTIONARY_FILENAME_ENG_NORMAL);
        seedDictionary = readFile(DICTIONARY_FILENAME_ENG_HARD);
    ...
    private static ArrayList<String> readFile(String englishFile) throws IOException {
        ...
        try {
            ...
            while (line != null) {
                ...
                if (word.length() >2 && !words.contains(word.toLowerCase())) words.add(word.toLowerCase());
                line = dic1.readLine();
            }
        } finally {
            dic1.close();
