 ...
 */
public class PlumberHugePressureGenerator {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    public PlumberHugePressureGenerator(int count, int minComplexity, int maxComplexity) {
        ...
        for(int i = 0; i < count; i++) {
            ...
            int dif = (difficulties[((int) (levelStartNumber + shifter + i * multiplier))]);
...
//                continue;
//            }
            ArrayList<ArrayList<WaterPath>> solution = model.findAllShortestPaths(minPathSize[((int) ((levelStartNumber + shifter + levelsGenerated * multiplier) / 16))]);
               ...
               // }
                for(int i = 0; i < count; i++) {
                    if (Math.abs(difficulty - levelGenerated[i]) < eps) {
                        ...
                        writeToFile("/home/suren/Documents/temp/plumber/update/pressure_start/" + (levelNumber + i) + ".txt", solution);
                        levelsGenerated++;
                        levelGenerated[i] = -1;
                        break;
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberHugePressureGenerator generator = new PlumberHugePressureGenerator(365, 0, 100);
