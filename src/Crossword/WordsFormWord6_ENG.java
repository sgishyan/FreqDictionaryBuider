 ...
 */
public class WordsFormWord6_ENG {
    ...
    public static void main(String[] args) throws IOException {
        WordsFormWord6_ENG w = new WordsFormWord6_ENG();

    }

    public WordsFormWord6_ENG() throws IOException {

        dictionary = readFile(DICTIONARY_FILENAME_ENG_EASY);
        seedDictionary = readFile(DICTIONARY_FILENAME_ENG_NORMAL);
...
//                }
        ...
        int countryIterator = 5;
        int packLevels = 1;
        int pack = 1;
        for (Crossword cr : globalBestSequence) {
            if (countryIterator >= 10) {
