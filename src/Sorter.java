...
public class Sorter {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "/home/suren/Documents/temp/dictionaries/new/variationsRare3.txt";
        String outPath = "/home/suren/Documents/temp/dictionaries/new/variationsRare.txt";
        ...
        while (!inputStrings.isEmpty()) {
            ...
            for (int j = 0; j < inputStrings.size(); j++) {
                int distance1 = Sorter.getDistance(currentString, inputStrings.get(j));
                int distance2 = 7;
                int distance3 = 7;
                int distance4 = 7;
                int distance5 = 7;
                if (currentIndex > 1) {
                    distance2 = Sorter.getDistance(outputStrings.get(currentIndex - 1), inputStrings.get(j));
                }
                if (currentIndex > 2) {
                    distance3 = Sorter.getDistance(outputStrings.get(currentIndex - 2), inputStrings.get(j));
                }
                if (currentIndex > 3) {
                    distance4 = Sorter.getDistance(outputStrings.get(currentIndex - 3), inputStrings.get(j));
                }
                if (currentIndex > 4) {
                    distance5 = Sorter.getDistance(outputStrings.get(currentIndex - 4), inputStrings.get(j));
                }
