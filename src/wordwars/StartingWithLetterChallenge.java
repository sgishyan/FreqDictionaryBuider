 ...
 */
public class StartingWithLetterChallenge extends ChallengeMetric {
    private int count;
    private char letter;

    public StartingWithLetterChallenge(Set<String> words, Set<String> basicWords, Set<String> mediumWords, int c, int time, char letter) {
    ...
    public void printMetrics() {
        System.out.println("BEG։  " + count + " " + time + " seconds " + ( letter) + "   "  + getChallengeValue());
