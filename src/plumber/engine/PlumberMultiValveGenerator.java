 ...
 */
public class PlumberMultiValveGenerator {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    public PlumberMultiValveGenerator(int count, int minComplexity, int maxComplexity) {
...
//                }
                   ...
                   for(int i = 0; i < count; i++) {
                       if (Math.abs(difficulty - levelGenerated[i]) < eps) {
                           ...
                           writeToFile("/home/suren/Documents/temp/plumber/ingame/multicolor/" + (levelNumber + i) + ".txt", solution);
                           levelsGenerated++;
                           levelGenerated[i] = -1;
                           break;
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberMultiValveGenerator generator = new PlumberMultiValveGenerator(365, 0, 100);
