 ...
 */
public class PlumberMultiValveDailyGenerator {
...
//    final int TOTAL_EMPTY = 10;
    int [][] level;
    public PlumberMultiValveDailyGenerator(int count, int minComplexity, int maxComplexity) {
        ...
        //Filling desired levels
        double levelPositionValue_modifier = 1.0;
        for(int i = 0; i < count; i++) {

            int dif = difficulties[550 + i];
            //int dif = 45;
...
//                System.out.println(dif);
            ...
            // int dif = (int)(levelPositionValue_modifier * (TOTAL_ANGLES + 2 * allSolutionsLength) / 2) ;
        ...
        int containersCount = 3;
           while(levelsGenerated < count) {
               ...
               PlumberMultiValveModel model = generateLevel(containersCount);
...
//            }
               ...
               ArrayList<ArrayList<WaterPath>> solution = model.findAllShortestPaths(7);
...
//                }
                   ...
                   for(int i = 0; i < count; i++) {
                       if (Math.abs(difficulty - levelGenerated[i]) < eps) {
                           ...
                           writeToFile("/home/suren/Documents/temp/plumber/for_sale/extreme_colors/" + (levelNumber + i) + ".txt", solution);
                           levelsGenerated++;
                           levelGenerated[i] = -1;
                           break;
...
//                }
    ...
    private PlumberMultiValveModel generateLevel(int containersCount) {
       // System.out.println("=============================================================");
...
//        maxComplexity = sc.nextInt();
        ...
        PlumberMultiValveDailyGenerator generator = new PlumberMultiValveDailyGenerator(365, 0, 100);
