 ...
 */
public class WaterPipesRotateLevelMultiColor {
    public static final String INPUT_DIRECTORY = "/home/suren/Documents/plumber_new_levels/multivalve_all/m_additional";
    public static final String OUTPUT_DIRECTORY = "/home/suren/Documents/plumber_new_levels/multivalve_all/m_additional_rotate";
...
//        }
    ...
    private static void remake(Level level) {
        ...
        if (difficulty < 20) {
            level.levelMoves = (int) (minMoves * 1.3);
        }else
        if (difficulty < 30) {
            level.levelMoves = (int) (minMoves * 1.4);
        }else
        if (difficulty < 40) {
            level.levelMoves = (int) (minMoves * 1.4);
        }else
        ...
        if (difficulty < 70) {
            level.levelMoves = (int) (minMoves * 1.8);
        }else {
    ...
    static class Level{
        ...
        public String upperPart = "Multivalve";
    }
}
