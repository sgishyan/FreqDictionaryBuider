...
public class GeneratorSpanish {
    ...
    public static void main(String[] args) throws IOException {
        GeneratorSpanish parser = new GeneratorSpanish();
        int count = parser.parseFile("/home/suren/Documents/temp/spanish/dictionary_description_cleared_short.txt", "/home/suren/Documents/temp/spanish/variations1.txt");
    ...
    public int parseFile(String filename, String wFilename) throws IOException {
        ...
        char[] newTopLetters = {'e', 'a', 'i', 'o', 'n', 'r', 't', 'l', 's', 'u','d','g', 'c', 'm', 'b', 'p', 'f', 'h', 'v', 'y', 'j', 'x', 'q', 'z', 'ñ'};
...
//       }
    ...
    private boolean checkLetters(ArrayList<String> dictionary, char[] letters) {
        ...
        if (currentWordsCount >= 40 && currentWordsCount <= 44)
        {
