 ...
 */
public class GeneratorEnglishFilter {
    ...
    public static void main(String[] args) throws IOException {
        GeneratorEnglishFilter parser = new GeneratorEnglishFilter();
        int count = parser.parseFile(
                "/home/suren/Documents/temp/dictionaries/new/child_used_3.txt",
                "/home/suren/Documents/temp/dictionaries/new/most_used_3.txt",
                "/home/suren/Documents/temp/dictionaries/new/rare_used_3.txt",
                "/home/suren/Documents/temp/dictionaries/new/variation_child_3.txt",
                "/home/suren/Documents/temp/Testing/frequencyChild.txt");
        System.out.println("WORDS COUNT " + count);


    }
    ArrayList<String> dictionaryChild ;
    ArrayList<String> dictionaryMost ;
    ArrayList<String> dictionaryRare ;
    Set<String> variationWords;
    public int parseFile(String filenameChild, String filenameMost, String filenameRare, String wFilename, String wFrequencyFilename) throws IOException {
        ...
        dictionaryChild = readFile(filenameChild);
        dictionaryMost = readFile(filenameMost);
        dictionaryRare = readFile(filenameRare);
                        ...
                        for (char c5 : newTopLetters)
                            for (char c6 : newTopLetters)
                                for (char c7 : newTopLetters){
                                    ...
                                    if (checkLetters(dictionaryChild, letters)) {

                                        int most = isAnWordPossible(dictionaryMost, letters);
...
//       }
    ...
    private boolean checkLetters(ArrayList<String> dictionary, char[] letters) {
        ...
        if (currentWordsCount >= 32 && currentWordsCount <= 44)
        {
