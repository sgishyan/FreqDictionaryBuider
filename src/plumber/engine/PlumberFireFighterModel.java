...
public class PlumberFireFighterModel {
	...
	public PlumberFireFighterModel(int[][] array, int h, int w, int containersNumber)
	{
        this.containersNumber = containersNumber;
        containers = new ArrayList<>(containersNumber);
		height=h;
		width=w;		
    ...
    public ArrayList<ArrayList<WaterPath>> findAllShortestPaths(int minSize) {
        ...
        for (int i = 0; i < containersNumber; i++) {
            solutions.clear();
            ArrayList<WaterPath> path = shortestPath(i);
            if (path == null) {
                return null;
            }
    ...
    public ArrayList<WaterPath> shortestPath (int containerIndex) {
