 ...
 */
public class VariationsSorterRussian {

    public static void main(String[] args) throws IOException {

        String path = "/home/suren/Documents/temp/rus/variations_all3.txt";
        String outPath = "/home/suren/Documents/temp/rus/variations_all_sorted3.txt";
        ArrayList<String> inputStrings = new ArrayList<String>(17000);
        ArrayList<String> outputStrings = new ArrayList<String>(17000);
        ...
        while (!inputStrings.isEmpty()) {
            ...
            for (int j = 0; j < inputStrings.size(); j++) {
                int distance1 = VariationsSorterRussian.getDistance(currentString, inputStrings.get(j));
                int distance2 = 7;
                int distance3 = 7;
                int distance4 = 7;
                int distance5 = 7;
                if (currentIndex > 1) {
                    distance2 = VariationsSorterRussian.getDistance(outputStrings.get(currentIndex - 1), inputStrings.get(j));
                }
                if (currentIndex > 2) {
                    distance3 = VariationsSorterRussian.getDistance(outputStrings.get(currentIndex - 2), inputStrings.get(j));
                }
                if (currentIndex > 3) {
                    distance4 = VariationsSorterRussian.getDistance(outputStrings.get(currentIndex - 3), inputStrings.get(j));
                }
                if (currentIndex > 4) {
                    distance5 = VariationsSorterRussian.getDistance(outputStrings.get(currentIndex - 4), inputStrings.get(j));
                }
