...
import protector.*;
import protector.EncryptImages;
import protector.RemoveLogs;
import protector.StringEncryption;
import protector.apwefmfgjjw;
...
//
//                    }
                    String enc = SpiderProtector.apwefmfgjjw._3_(source);
                    String dec = protector.apwefmfgjjw._3_(enc);
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException, InstantiationException, IllegalAccessException {
        ...
        System.out.println(apwefmfgjjv._1_("абвгдеёжзийклмнопрстуфхцчшщъыьэюяАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ", 10));

        System.out.println(  apwefmfgjjv._1_("МолодецǶǶǶХорошийʿстарт", 10));

        String aa = "Hello Спасибо тебе огромное!";
        ...
        String c = protector.apwefmfgjjw._3_(a);
        String b = protector.apwefmfgjjw._3_(c);
       ...
       //   System.out.println(apwefmfgjjw._3_("ﾫﾐﾊﾜﾗ\uFFDFﾋﾗﾚ\uFFDFﾏﾖﾏﾚﾌﾣﾑﾋﾐ\uFFDFﾋﾊﾍﾑ\uFFDFﾋﾗﾚﾒ\uFFD1"));
          new RemoveLogs("/home/suren/Documents/spider_exp/android/src/com/mobiloids/spiderwords", "");
          new RemoveLogs("/home/suren/Documents/spider_exp/core/src/com/mobiloids/spiderwords", "");

          new StringEncryption("/home/suren/Documents/spider_exp/android/src/com/mobiloids/spiderwords", "import static com.mobiloids.spiderwords.apwefmfgjjv._1_;",  "_1_", 10);
          new StringEncryption("/home/suren/Documents/spider_exp/core/src/com/mobiloids/spiderwords", "import static com.mobiloids.spiderwords.apwefmfgjjv._1_;",  "_1_", 10);
      ...
      //    new LayoutEncryption("/home/suren/Documents/plumber_exp/main", "", "apwefmfgjjw", "_3_");
          //new JavaFileNameEncryptions("/home/suren/Documents/spider_exp/core/src/com/mobiloids/spiderwords", "", "apwefmfgjjw", "_3_");
          //new JavaFileNameEncryptions("/home/suren/Documents/spider_exp/android/src/com/mobiloids/spiderwords", "", "apwefmfgjjw", "_3_");
         //  new protector.ValuesEncryption("/home/suren/Documents/plumber_exp/main", "", "apwefmfgjjw", "_3_", "import static com.mobiloids.waterpipespuzzle.apwefmfgjjw._3_;");
    }
